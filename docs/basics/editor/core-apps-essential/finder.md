...
Invokable with `finder` command.

Supports `sudo` command, as well as `su`, followed by the invoke command.

Supports path arguments. Eg. `finder ~/Desktop` or `finder home/guest`
